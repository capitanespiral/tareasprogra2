...
class odeint{
 ...
 public:
  ...
  matriz<matriz<double>> euler_cromer(matriz<double> (*g)(double,const matriz<double> &,const matriz<double> &,matriz<double> &),double=0,char='a');
  matriz<matriz<double>> rk4(matriz <double> (*g)(double,const matriz<double> &,const matriz<double> &,matriz<double> &),double=0,char='a');
  ...
  matriz<matriz<double>> vel_velver(matriz <double> (*g)(double,const matriz<double> &,const matriz<double> &,matriz<double> &),double=0,char='a');
  matriz<matriz<double>> pefrl(matriz<double> (*g)(double,const matriz<double> &,const matriz<double> &,matriz<double> &),double=0,char='a');
};
